...
describe('Stats API Route - Work Session Counting', () => {
  ...
  describe('Work Session Counting', () => {
    it('should count work sessions from long tasks', async () => {
      setupMockFetch({
    ...
    it('should combine work sessions with completed tasks for same project', async () => {
      setupMockFetch({
        'filters[completed][$eq]=true': {
          data: [
            {
  ...
  describe('Edge Cases', () => {
    it('should handle long tasks with no work sessions', async () => {
      setupMockFetch({
        'filters[completed][$eq]=true': {
          data: [],
          meta: { pagination: { page: 1, pageCount: 1 } },
    ...
    it('should handle long tasks with null work sessions', async () => {
      setupMockFetch({
        'filters[completed][$eq]=true': {
          data: [],
          meta: { pagination: { page: 1, pageCount: 1 } },
    ...
    it('should skip recurring long tasks with work sessions', async () => {
      setupMockFetch({
        'filters[completed][$eq]=true': {
          data: [],
          meta: { pagination: { page: 1, pageCount: 1 } },
    ...
    it('should not count work sessions for incidental tasks', async () => {
      setupMockFetch({
        'filters[completed][$eq]=true': {
          data: [],
          meta: { pagination: { page: 1, pageCount: 1 } },
  ...
  describe('Multiple Long Tasks', () => {
    it('should aggregate work sessions across multiple long tasks', async () => {
      setupMockFetch({
        'filters[completed][$eq]=true': {
          data: [],
          meta: { pagination: { page: 1, pageCount: 1 } },
      ...
      expect(projectStat).toBeDefined();
      expect(projectStat.count).toBe(2); // 1 session from each long task
    });
  });
